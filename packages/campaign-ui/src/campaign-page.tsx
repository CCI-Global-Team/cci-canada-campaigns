    ...
    <>
      ...
      <main className="min-h-screen bg-[color:var(--campaign-ink)] text-[color:var(--campaign-cream)]">
        <div className="relative overflow-hidden">
          ...
          <section className="relative z-10 flex min-h-[88svh] items-end overflow-hidden px-6 py-16 sm:px-10 lg:px-[5vw] lg:pb-[8vh]">
            <div
            ...
            <div className="relative z-10 max-w-5xl">
              ...
              <h1 className="font-display text-[clamp(3.25rem,11vw,8.75rem)] font-extrabold uppercase leading-[0.86] tracking-[0.01em] text-[color:var(--campaign-cream)] drop-shadow-[0_0_50px_rgba(255,138,51,0.4)]">
